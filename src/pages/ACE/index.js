          ...
          <div className={css.applyBox}>
            ...
            <div className={css.content}>
              ...
              <div className={css.word}>
                1、Blind box subscription registration is required to pay 55
                USDT;
                <br />
            ...
            <div className={css.footer}>
              ...
              <div className={css.buttonBox}>
                <div
                  className={classNames(
                    css.button,
                    css.buttonLeft,
                    USDT_APPROVE_AMOUNT - 55 >= 0 && css.no
                  )}
                  onClick={() => {
                    if (USDT_APPROVE_AMOUNT - 55 < 0) {
                      toApproveUSDT();
                    }
                  }}
                >
              ...
              <div className={css.need}>
                ...
                <span className={css.needNum}>
                  <span className={css.depreciate}>100 USDT</span>55 USDT
                </span>
              </div>
